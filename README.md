...
## Known issue
Sometimes the video will stck at loading so I'm finding a solution for this.
...
- I removed auto reload logic,fixed All VP9 not working and updated some A/B settings from PoomSmart so now 2K and 4K videos should playing fine.
