...
- And in main YTUHD repo,PoomSmart try to make 2K and 4K work in older devices (older than A12 chip) but some logic don't work with sideloading. (Even he tries his best.)
- Plus my main point is to make 2K and 4K work in A12 chip and newer,so I created this repo to solve this.
- I removed auto reload logic,fixed All VP9 not working,fix settings crashes and updated some codes from PoomSmart so now 2K and 4K videos should playing fine.
