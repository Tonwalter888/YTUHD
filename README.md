...
- And in main YTUHD repo,PoomSmart try to make 4K works in older devices (older that A12 chip) but some logic don't work with Sideloading.
- Plus my main point is make 4K works in A12 chip and newer,so I created this repo to solve this.
- I removed the auto reload logic,fix All VP9 not working and update some A/B settings from PoomSmart so now 2K and 4K videos should playing fine.
