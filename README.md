...
- I set the auto reload video thing to wait time buffers from 2 seconds to 3 seconds and I NEED to disable HDR due to some playback issues,I'm sorry if you want HDR.
